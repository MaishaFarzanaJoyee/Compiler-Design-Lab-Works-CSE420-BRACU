...
%token IF ELSE FOR WHILE DO GOTO BREAK CONTINUE RETURN INT FLOAT CHAR VOID DOUBLE SWITCH CASE DEFAULT PRINTF PRINTLN ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COLON SEMICOLON COMMA ID CONST_INT CONST_FLOAT  
...
int main(int argc, char *argv[]) {
    ...
    outlog.open("22101343_21201065.txt", ios::trunc);
